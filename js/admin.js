...
(function ($) {
          ...
          if ("" != o && void 0 !== o) {
            ...
            e.content || t.removeAttr("title"),
              "hover" == e.event
                ? (t.hover(
                    function () {
                      n.removeAttr("click"), (r = !0), s.call(this);
                    },
                    function () {
                      (r = !1), d();
                    }
            ...
            var s = function () {
                e.show && e.show.call(this, e),
                  e.content && "" != e.content && (o = e.content),
                  a.html(o),
                  e.render && e.render(n),
                ...
                if (i) {
                  ...
                  var f = t.parent().attr("name"),
                    ...
                    p =
                      parseInt(l.left, 10) +
                      parseInt(
                        (parseInt(s.sort(h)[0], 10) +
                          parseInt(s.sort(h)[s.length - 1], 10)) /
                          2,
                        10
                      ),
                    u =
                      parseInt(l.top, 10) +
                      parseInt(
                        (parseInt(d.sort(h)[0], 10) +
                          parseInt(d.sort(h)[d.length - 1], 10)) /
                          2,
                        10
                      );
                } else
                  (u = parseInt(t.offset().top, 10)),
                    (p = parseInt(t.offset().left, 10));
                var m = i ? 0 : parseInt(t.outerWidth(), 10),
                  ...
                  y = 0,
                  H =
                    p + m + v + e.offset + 8 > parseInt($(window).width(), 10),
                  W = v + e.offset + 8 > p,
                ...
                W || ("e" == e.anchor && !H)
                  ? ("w" != e.anchor && "e" != e.anchor) ||
                    ((x = "e"),
                    (y = Math.round(
                      w / 2 - 8 - parseInt(n.css("borderRightWidth"), 10)
                    )),
                    (b = -8 - parseInt(n.css("borderRightWidth"), 10)),
                    (g = p + m + e.offset + 8),
                    (T = Math.round(u + I / 2 - w / 2)))
                  : (H || ("w" == e.anchor && !W)) &&
                    (("w" != e.anchor && "e" != e.anchor) ||
                      ((x = "w"),
                      (y = Math.round(
                        w / 2 - 8 - parseInt(n.css("borderLeftWidth"), 10)
                      )),
                      (b = v - parseInt(n.css("borderLeftWidth"), 10)),
                      (g = p - v - e.offset - 8),
                      (T = Math.round(u + I / 2 - w / 2)))),
                  M || ("n" == e.anchor && !k)
                    ? ("n" != e.anchor && "s" != e.anchor) ||
                      ((x = "n"),
                      (y = w - parseInt(n.css("borderTopWidth"), 10)),
                      (T = u - (w + e.offset + 8)))
                    : (k || ("s" == e.anchor && !M)) &&
                      (("n" != e.anchor && "s" != e.anchor) ||
                        ((x = "s"),
                        (y = -8 - parseInt(n.css("borderBottomWidth"), 10)),
                        (T = u + I + e.offset + 8))),
                  "n" == e.anchor || "s" == e.anchor
                    ? v / 2 > p
                      ? ((g = g < 0 ? b + g : b), (b = 0))
                      : p + v / 2 > parseInt($(window).width(), 10) &&
                        ((g -= b), (b *= 2))
                    : k
                    ? ((T += y), (y = 0))
                    : M && ((T -= y), (y *= 2)),
                  ...
                  (delay = setTimeout(function () {
                    n.css({ "margin-left": g + "px", "margin-top": T + "px" })
                      .stop(!0, !0)
                      .fadeIn(e.fadeIn);
                  }, e.delay)),
                  n.attr("class", "sb-tooltip " + x);
              },
              d = function () {
                ((!e.aHide && !i) || e.aHide) &&
                  (delay && clearTimeout(delay),
  ...
  // Language switcher
  $.fn.sbLanguageSwitcher = function (
    langs = [],
    source = "",
    ...
    let added = [];
    let element = $(this).hasClass("sb-language-switcher-cnt")
      ? $(this)
    ...
    for (var i = 0; i < langs.length; i++) {
      ...
      code += `<span ${
        active_language == language ? 'class="sb-active" ' : ""
      }data-language="${language}"${
        id ? ' data-id="' + id + '"' : ""
      }><i class="sb-icon-close"></i><img src="${SB_URL}/media/flags/${language.toLowerCase()}.png" /></span>`;
      added.push(language);
    }
  ...
  function saved_reply_search(search) {
    SBF.search(search, () => {
      ...
      let no_results = `<li class="sb-no-results">${sb_(
        "No results found."
      )}</li>`;
      for (var i = 0; i < saved_replies_list.length; i++) {
        if (
          all ||
          saved_replies_list[i]["reply-name"].toLowerCase().includes(search) ||
        ...
        for (var i = 0; i < response.length; i++) {
          if (
            ...
            (!SB_ACTIVE_AGENT.department ||
              ...
              SB_ACTIVE_AGENT.department == !response[i].department)
          ) {
  ...
  function getListConversation(conversation_id) {
    return conversations_admin_list_ul.find(
  ...
  var SBApps = {
    dialogflow: {
        ...
        SBF.ajax(
          ...
          (response) => {
            ...
            if (
              ...
              let code = "";
              let is_bottom =
                conversations_area_list[0].scrollTop ===
                conversations_area_list[0].scrollHeight -
                  conversations_area_list[0].offsetHeight;
      ...
      showCreateIntentBox: function (message_id) {
        ...
        if (SBF.isAgent(message.get("user_type"))) {
          ...
          if (expression) {
            expression = expression.payload("translation")
              ? expression.payload("translation")
              : expression.message;
          }
          ...
          expression = message.payload("translation")
            ? message.payload("translation")
            : response;
          let agent_message = SBChat.conversation.getNextMessage(
            message.id,
            "agent"
          );
          if (agent_message) {
            response = agent_message.payload("original-message")
              ? agent_message.payload("original-message")
      ...
      submitIntent: function (button) {
        ...
        if ((!response && !intent_name) || expressions.length == 0) {
          ...
          let is_dialogflow =
            services == "open-ai" ||
            dialogflow_intent_box.hasClass("sb-dialogflow-disabled");
          SBF.ajax(
            {
              function: is_dialogflow
                ? "embeddings-database"
                : !intent_name
                ? "dialogflow-create-intent"
                : "dialogflow-update-intent",
              questions_answers: is_dialogflow
                ? [[expressions[0], response]]
                : false,
      ...
      previewIntent: function (name) {
        ...
        if (intent) {
          let training_phrases = intent.trainingPhrases
    ...
    openAI: {
      ...
      generateIntents: function (expression) {
        if (SB_ADMIN_SETTINGS.open_ai_user_expressions && expression) {
          ...
          SBF.ajax(
            { function: "open-ai-user-expressions", message: expression },
            (response) => {
              let code = "";
              for (var i = 0; i < response.length; i++) {
                if (response[i]) {
                  code += `<div class="sb-input-setting sb-type-text sb-open-ai-intent"><input type="text" value="${response[
                    i
                  ].replace(/"/g, "")}"></div>`;
                }
              }
      ...
      crawler: {
        ...
        start: function (urls) {
          if (urls.length) {
            ...
            dialog_box.html(
              sb_("We are processing the source") +
                "<pre>" +
                url +
                "</pre><span>" +
                sb_("Only {R} sources left to complete.").replace(
                  "{R}",
                  urls.length + 1
                ) +
                "</span>"
            ...
            if (url.includes(".xml")) {
              ...
              SBF.ajax(
                { function: "get-sitemap-urls", sitemap_url: url },
                (response) => {
                  if (Array.isArray(response)) {
              ...
              this.active_source = url;
              SBF.ajax(
                { function: "open-ai-source-file-to-paragraphs", url: url },
                (response) => {
                  if (Array.isArray(response)) {
                    if (response.length) {
              ...
              this.start_urls.includes(url) &&
              !this.sitemap_processed_urls.includes(url) &&
                    ...
                    if (href) {
                      $(this).html(
                        href.includes("http")
                          ...
                          : absolute_url(
                              href,
                              SBApps.openAI.crawler.base_url
                                ? SBApps.openAI.crawler.base_url
                                : url
                            )
                      );
                  ...
                  for (var i = 0; i < list_2.length; i++) {
                    ...
                    if (text.length > 3500) {
                      ...
                      for (var j = 0; j < texts.length; j++) {
                        if (
                          text.length + texts[j].length < 3500 ||
                          j == texts.length - 1
                        ) {
                          text += texts[j];
                        } else {
            ...
            admin
              ...
              .html(sb_("We are processing the articles."));
          ...
          if (urls.length) {
            ...
            if (url.lastIndexOf("http") === 0) {
              ...
              admin
                .find("#sb-embeddings-box p")
                .html(
                  sb_("We are generating the sitemap") +
                    "<pre>" +
                    url +
                    "</pre><span>" +
                    sb_("Only {R} pages left to complete.").replace(
                      "{R}",
                      urls.length + 1
                    ) +
                    "</span>"
                ...
                links.each((i, element) => {
                  ...
                  if (inner_url) {
                    ...
                    if (inner_url.includes("#")) {
                      inner_url = inner_url.substring(
                        0,
                        inner_url.indexOf("#")
                      );
                    }
                    if (
                      !sitemap_urls.includes(inner_url) &&
                      !urls.includes(inner_url) &&
                      inner_url.indexOf(url.origin) === 0 &&
                      (!inner_url
                        .substring(inner_url.lastIndexOf("/"))
                        .includes(".") ||
        ...
        getHTML: function (url, onSuccess) {
          ...
          SBF.ajax({ function: "get-html", url: url }, function (response) {
            ...
            if (response[1] == 200) {
              response = response[0];
              language = response.substring(
                response.indexOf("<html"),
                response.indexOf(">", response.indexOf("<html"))
              );
              if (language.includes("lang=")) {
                let index = response.indexOf("lang=") + 6;
                language = response
                  .substring(index, response.indexOf('"', index))
                  .toLowerCase();
              } else {
                language = "";
              }
        ...
        embeddings: function (paragraphs, onSuccess) {
          ...
          SBF.ajax(
            ...
            (response) => {
              ...
              if (
                response[1] == "chars-limit-exceeded" ||
                (response[1] && response[1][0] && response[1][0].error)
              ) {
                infoPanel(
                  response[1] == "chars-limit-exceeded"
                    ? sb_(
                      ...
                      ).replace("{R}", response[2])
                    : response[1][0].error.message,
                  "info"
                );
                onSuccess(false);
                this.training_button.sbLoading(false);
    ...
    aecommerce: {
      ...
      conversationPanel: function () {
        ...
        if (!this.panel)
          this.panel = conversations_area.find(".sb-panel-aecommerce");
        if (aecommerce_id && !loading(this.panel)) {
          SBF.ajax(
            ...
            (response) => {
              ...
              }</h3><div><div class="sb-split"><div><div class="sb-title">${sb_(
                "Number of orders"
              )}</div><span>${response.orders_count} ${sb_(
                "orders"
              )}</span></div><div><div class="sb-title">${sb_(
                "Total spend"
              )}</div><span>${response.currency_symbol}${
                response.total
              }</span></div></div><div class="sb-title">${sb_(
                "Cart"
              ...
              if (response.orders.length) {
                ...
                for (var i = 0; i < response.orders.length; i++) {
                  ...
                  code += `<a data-id="${id}" href="${
                    ...
                    order.time,
                    true
                  )}</span> <span>${response.currency_symbol}${
                    order.price
                  }</span></a>`;
                }
                code += "</div>";
    ...
    martfury: {
      ...
      conversationPanel: function () {
        ...
        if (!this.panel)
          this.panel = conversations_area.find(".sb-panel-martfury");
    ...
    whmcs: {
      ...
      conversationPanel: function () {
        ...
        if (!this.panel)
          this.panel = conversations_area.find(".sb-panel-whmcs");
        if (whmcs_id && !loading(this.panel)) {
          SBF.ajax(
            ...
            (response) => {
              ...
              code = `<h3>WHMCS</h3><div><div class="sb-split"><div><div class="sb-title">${sb_(
                "Number of services"
              )}</div><span>${response.services_count} ${sb_(
                "services"
              )}</span></div><div><div class="sb-title">${sb_(
                "Total spend"
              )}</div><span>${response.currency_symbol}${
              ...
              code += `<a href="${
                ...
                response["client-id"]
              }" target="_blank" class="sb-btn sb-whmcs-link">${sb_(
                "View on WHMCS"
              )}</a>`;
              $(this.panel).html(code).sbLoading(false);
              collapse(this.panel, 160);
          ...
          .html(
            perfex_id
              ? `<a href="${
                  ...
                  perfex_id.value
                }" target="_blank" class="sb-btn sb-perfex-link">${sb_(
                  "View on Perfex"
                )}</a>`
              : ""
          );
          ...
          (response) => {
            ...
            if (subscriptions.length) {
              ...
              for (var i = 0; i < subscriptions.length; i++) {
                ...
                code += `<div${expired ? ' class="sb-expired"' : ""}><span>${
                  subscriptions[i].label
                }</span><span>${sb_(
                  expired ? "Expired on" : "Expires on"
                )} ${SBF.beautifyTime(
                  subscriptions[i].expire_time,
                  false,
                  !expired
                )}</span></div>`;
              }
              code += `</div><span class="sb-title">${sb_("Total spend")} ${
    ...
    armember: {
      ...
      conversationPanel: function () {
        ...
        if (!this.panel)
          this.panel = conversations_area.find(".sb-panel-armember");
        if (!SBF.null(wp_user_id) && !loading(this.panel)) {
          ...
          SBF.ajax(
            ...
            (response) => {
              subscriptions = response.subscriptions;
              if (subscriptions.length) {
                code = `<i class="sb-icon-refresh"></i><h3>${sb_(
                  "Plans"
                )}</h3><div class="sb-list-names">`;
                for (var i = 0; i < subscriptions.length; i++) {
                  let expired = subscriptions[i].expired;
                  code += `<div${expired ? ' class="sb-expired"' : ""}><span>${
                    subscriptions[i].arm_current_plan_detail
                      .arm_subscription_plan_name
                  }</span><span>${
                    subscriptions[i].expire_time == "never"
                      ? ""
                      : sb_(expired ? "Expired on" : "Expires on") +
                        " " +
                        SBF.beautifyTime(
                          subscriptions[i].expire_time,
                          false,
                ...
                code += `</div><span class="sb-title">${sb_("Total spend")} ${
                  response.currency_symbol
                }${response.total}<a href="${
                  window.location.href.substr(
                    0,
                    window.location.href.lastIndexOf("/")
                  ) +
                  "?page=arm_manage_members&member_id=" +
                  activeUser().getExtra("wp-id").value
                }" target="_blank" class="sb-btn-text"><i class="sb-icon-user"></i> ${sb_(
                  "View member"
                )}</a></span>`;
              }
              $(this.panel).html(code).sbLoading(false);
    ...
    woocommerce: {
      ...
      popupFilter: function (item) {
        ...
        SBF.ajax(
          ...
          (response) => {
            woocommerce_products_box_ul
              .html(this.popupCode(response))
              .sbLoading(false);
          }
        );
      },
      ...
      popupPopulate: function (onSuccess = false) {
        this.popupLanguage =
          activeUser() != false &&
          SB_ADMIN_SETTINGS.languages.includes(activeUser().language)
            ? activeUser().language
            : "";
        this.popupPaginationNumber = 1;
        ...
        SBF.ajax(
          ...
          (response) => {
            ...
            select
              .find("ul")
              .html(
                `<li data-value="" class="sb-active">${sb_("All")}</li>` + code
              );
            woocommerce_products_box_ul
              .html(this.popupCode(response[0]))
              .sbLoading(false);
      ...
      popupPagination: function (area) {
        ...
        SBF.ajax(
          ...
          (response) => {
            woocommerce_products_box_ul
              .append(this.popupCode(response, false))
              .sbLoading(false);
      ...
      conversationPanel: function () {
        ...
        SBF.ajax(
          ...
          (response) => {
            code = `<i class="sb-icon-refresh"></i><h3>WooCommerce</h3><div><div class="sb-split"><div><div class="sb-title">${sb_(
              "Number of orders"
            )}</div><span>${response.orders_count} ${sb_(
              "orders"
            )}</span></div><div><div class="sb-title">${sb_(
            ...
            if (response.orders.length) {
              ...
              for (var i = 0; i < response.orders.length; i++) {
                let order = response.orders[i];
                let id = order.id;
                code += `<div data-id="${id}"><span><span>#${id}</span> <span>${SBF.beautifyTime(
                  order.date,
                  true
                )}</span><a href="${SITE_URL}/wp-admin/post.php?post=${id}&action=edit" target="_blank" class="sb-icon-next"></a></span><div></div></div>`;
              }
              code += "</div>";
            }
            $(this.panel).html(code).sbLoading(false);
        ...
        SBF.ajax(
          ...
          (response) => {
            ...
            if (response) {
              ...
              code += `<div class="sb-title">${sb_("Order total")}: <span>${
                response.currency_symbol
              }${response.total}<span></div><div class="sb-title">${sb_(
                "Order status"
              )}: <span>${SBF.slugToString(
                response.status.replace("wc-", "")
              )}<span></div><div class="sb-title">${sb_(
                "Date"
              )}: <span>${SBF.beautifyTime(
                response.date,
                true
              )}<span></div><div class="sb-title">${sb_("Products")}</div>`;
              ...
              for (var i = 0; i < 2; i++) {
                ...
                if (response[key + "_address"]) {
                  ...
                  )}</div><div class="sb-multiline">${response[
                    key + "_address"
                  ].replace(/\\n/g, "<br>")}</div>`;
                }
              }
            ...
            SBF.ajax(
              ...
              (response) => {
                ...
                if (count > 60 || removed) {
                  ...
                  conversations_area
                    .find(".sb-add-cart-btn,.sb-woocommerce-cart > a i")
                    .sbLoading(false);
    ...
    is: function (name) {
      ...
      switch (name) {
        ...
        case "slack":
        case "tickets":
          return typeof SB_VERSIONS[name] != ND && SB_VERSIONS[name];
        case "wordpress":
        ...
        if (message.includes("[" + unsupported[i]))
          infoBottom(
            "The {R} rich message is not supported by {R2}. The rich message was not sent to {R2}."
              .replace(/{R}/g, SBF.slugToString(unsupported[i]))
              .replace(/{R2}/g, app_name),
            "error"
          );
      }
    },
      ...
      if (action == "set") {
        ...
        if (items.length) {
          ...
          for (var i = 0; i < items.length; i++) {
            ...
            html += `<div class="repeater-item">${item
              .html()
              .replace(
        ...
        switch (type) {
          ...
          case "more":
            code = `<h2>${sb_(
              ...
              "Tags"
            )}</h2><div class="sb-input-setting sb-type-text"><div><input data-id="tags" type="text"></div></div><h2>${sb_(
              "Article IDs"
            )}</h2><div class="sb-input-setting sb-type-number"><div><input data-id="articles" type="text"></div></div><h2>${sb_(
              "Articles category"
        ...
        if (isString(values)) {
          ...
          for (var key in values) {
            setting
              .find("#" + key)
              .find("input, textarea")
              .val(isString(values[key]) ? values[key] : values[key][0]);
          }
        }
      },
  ...
  var SBArticles = {
    ...
    save: function (onSuccess = false) {
      ...
      article = {
        ...
        content: articles_area.find(".sb-article-content textarea").val(),
        link: articles_area.find(".sb-article-link input").val(),
        parent_category: articles_category_parent_select.val(),
        category: articles_category_select.val(),
        language: articles_area
          .find(".sb-language-switcher [data-language].sb-active")
          .attr("data-language"),
      };
        ...
        (response) => {
          ...
          if (is_number) {
            ...
            if (article.language) {
              ...
              articles_content
                .find(
                  `.sb-language-switcher [data-language="${article.language}"]`
                )
                .attr("data-id", response);
              for (var i = 0; i < translations.length; i++) {
                if (translations[i][0] == article.language) {
                  translations[i][1] = article.id;
                  SBArticles.translations.list[article.parent_id] =
                    translations;
                  break;
                }
              }
          ...
          if (!article.language) {
            articles_area
              .find(".ul-articles .sb-active")
              .html(article.title + '<i class="sb-icon-delete"></i>')
          ...
          infoBottom(
            response === true || is_number ? "Article saved" : response
          );
        }
      );
    },
    ...
    show: function (article_id) {
      ...
      this.get((response) => {
        ...
        response = response[0];
        articles_content.sbLanguageSwitcher(
          this.translations.get(
            response.parent_id ? response.parent_id : article_id
          ),
          "articles",
          response.language
        );
        ...
        articles_area
          .find("#sb-article-id")
          .html(`ID <span>${article_id}</span>`);
        articles_area
          .find(".sb-article-categories")
          .setClass("sb-hide", response.language);
        if (editor_js || articles_area.find("#editorjs").length) {
          editorJSLoad(
            response.editor_js
              ? isString(response.editor_js)
                ? JSON.parse(response.editor_js)
                : response.editor_js
              : response.content
          );
        } else {
    ...
    populate: function (items, is_category = false) {
      ...
      articles_area
        .find(is_category ? ".ul-categories" : ".ul-articles")
        .html(code);
      articles_area
        .find(is_category ? ".ul-categories > li" : ".ul-articles > li")
        .eq(0)
        .click();
      if (!items.length) {
        $(is_category ? articles_content_categories : articles_content)
          .sbLoading(false)
          .addClass("sb-hide");
      }
    },
    ...
    activeID: function (is_parent = false) {
      return is_parent
        ? articles_area.find(".ul-articles .sb-active").attr("data-id")
        : articles_content.attr("data-id");
    },
    ...
    viewButton: function (article_id = false) {
      if (this.page_url) {
        ...
        button.attr(
          "href",
          article_id ? this.page_url + "?article_id=" + article_id : ""
        );
      }
    },
    ...
    categories: {
      ...
      show: function (category_id, language = false) {
        ...
        if (index !== false) {
          let category = language
            ? this.list[index].languages[language]
            : this.list[index];
          let image = articles_content_categories.find("#category-image");
          this.updateActive();
          articles_content_categories
            .find("#category-title")
            .val(category.title);
          articles_content_categories
          ...
          articles_content_categories
            ...
            .prop("checked", category.parent ? true : false);
          articles_content_categories.sbLanguageSwitcher(
            $.map(this.list[index].languages, function (e, index) {
              return index;
            }),
            "article-categories",
            language
          ...
          if (category.image) {
            image
              .attr("data-value", category.image)
      ...
      update: function () {
        ...
        for (var i = 0; i < this.list.length; i++) {
          code[
            this.list[i].parent ? 0 : 1
          ] += `<option value="${this.list[i].id}">${this.list[i].title}</option>`;
        }
      ...
      updateActive: function () {
        ...
        if (id) {
          ...
          let language = articles_content_categories
            .find(".sb-language-switcher .sb-active")
            .attr("data-language");
          let category = {
            title: articles_content_categories.find("#category-title").val(),
            description: articles_content_categories
              .find("#category-description")
              .val(),
            image: articles_content_categories
              .find("#category-image")
              .attr("data-value"),
          };
          if (language) {
            ...
            category.parent = articles_content_categories
              .find("#category-parent")
              .is(":checked");
            category.languages = this.list[index].languages;
            this.list[index] = category;
            articles_area
              .find(".ul-categories .sb-active")
              .html(category.title + '<i class="sb-icon-delete"></i>')
      ...
      translations: {
        add: function (language_code, category_id = false) {
          ...
          if (SBF.null(SBArticles.categories.list[index].languages))
            SBArticles.categories.list[index].languages = {}; // Deprecated
          SBArticles.categories.list[index].languages[language_code] = {
            title: "",
            description: "",
            image: "",
          };
          articles_content_categories.sbLanguageSwitcher(
            $.map(
              SBArticles.categories.list[index].languages,
              function (e, index) {
                return index;
              }
            ),
        ...
        delete: function (language_code, category_id = false) {
          ...
          delete SBArticles.categories.list[
            SBArticles.categories.getIndex(category_id)
  ...
  var SBReports = {
    ...
    initChart: function (data, type = "line", label_type = 1) {
      let values = [];
      let labels = [];
      let blues = SB_ADMIN_SETTINGS.color
    ...
    initDatePicker: function () {
      ...
      settings.ranges[sb_("Last 30 Days")] = [
      ...
      settings.ranges[sb_("Last Month")] = [
  ...
  var SBUsers = {
    ...
    getRow: function (user) {
      if (user instanceof SBUser) {
        ...
        return `<tr data-user-id="${user.id}" data-user-type="${
          ...
          user.name
        }</span></a></td>${code}<td class="sb-td-email">${user.get(
          "email"
          ...
          true
        )}</td><td>${SBF.beautifyTime(user.get("creation_time"))}</td></tr>`;
      } else {
    ...
    csv: function () {
      SBF.ajax(
        { function: "csv-users", users_id: SBUsers.getSelected() },
        (response) => {
  ...
  var SBConversations = {
    ...
    openConversation: function (
      ...
      if (user_id === false && conversation_id) {
        ...
        let new_user =
          SBF.null(users[user_id]) || !users[user_id].details.email;
        ...
        if (conversation_id != -1) {
          activeUser().getFullConversation(conversation_id, (response) => {
            ...
            SBAdmin.must_translate =
              ...
              activeUser().language &&
              SB_ADMIN_SETTINGS.active_agent_language != activeUser().language;
            if (SBAdmin.must_translate) {
              ...
              for (var i = 0; i < response.messages.length; i++) {
                ...
                if (message.message) {
                  if (
                    (message.payload("original-message") &&
                      (!message.payload("original-message-language") ||
                        message.payload("original-message-language") ==
                          SB_ADMIN_SETTINGS.active_agent_language)) ||
                    (message.payload("translation") &&
                      (!message.payload("translation-language") ||
                        message.payload("translation-language") ==
                          SB_ADMIN_SETTINGS.active_agent_language))
                  ) {
                    ...
                    if (response_translate) {
                      for (var i = 0; i < response_translate.length; i++) {
                        this.openConversation_2(
                          message_ids[i],
                          message_user_types[i],
                          response_translate[i]
                        );
                      }
                    }
                    if (SB_ADMIN_SETTINGS.smart_reply) {
                      this.openConversation_1(
                        SBChat.conversation,
                        suggestions_area
                      );
                    }
              ...
              for (var i = 0; i < messages_translated.length; i++) {
                this.openConversation_2(
                  messages_translated[i].id,
                  messages_translated[i].user_type,
                  messages_translated[i].payload("original-message")
                    ? messages_translated[i].payload("original-message")
                    : messages_translated[i].payload("translation")
                );
              }
            }
            ...
            if (select_departments.length) {
              let department = response.get("department")
                ? this.getDepartments(response.get("department"))
                : false;
              ...
              select_departments
                .find(" > p")
                .attr("data-id", department ? department["department-id"] : "")
                .attr("data-value", color)
                .html(
                  department
                    ? department["department-name"] + "<span></span>"
                    : sb_("None")
                );
            }
            ...
            if (
              ...
              !SBConversations.filters()[1] &&
              !SBConversations.filters()[3]
            ) {
                  ...
                  if (rich_message.type == "rating") {
                    conversations_area
                      ...
                      .append(
                        ...
                        }"></i><span>${sb_("User rating")}</span><label>${sb_(
            ...
            activeUser().getConversations(function (response) {
              conversations_area
                ...
                .html(
                  response.length == 1
                    ? ""
                    : activeUser().getConversationsCode(response)
                )
                .prev()
                .setClass("sb-hide", response.length == 1);
            });
        ...
        this.startRealTime();
        if (
          SBF.getURL("conversation") != conversation_id &&
          conversation_id != -1
        ) {
    ...
    populateList: function (response) {
      ...
      for (var i = 0; i < response.length; i++) {
        ...
        conversations.push(
          new SBConversation([new SBMessage(response[i])], response[i])
        );
      }
      if (!code) {
            ...
            if (response.length) {
              ...
              for (var i = 0; i < response.length; i++) {
                if (!id_check.includes(response[i].id)) {
                  ...
                  if (
                    is_pending_status_code &&
                    (!active_conversation ||
                      SBF.visibility_status == "hidden") &&
                    (is_user ||
                      message.payload("human-takeover-message-confirmation"))
                  ) {
                    let notifications_counter = SBF.storage(
                    ...
                    if (
                      !notifications_counter[conversation_id].includes(
                        message.id
                      )
                    ) {
                  ...
                  if (active_conversation) {
                    ...
                    if (is_existing_conversation) {
                      ...
                      conversations[conversation_index].set(
                        "status_code",
                        status_code
                      );
                  ...
                  if (!active_conversation || !is_existing_conversation) {
                    if (is_pending_status_code) {
                      ...
                      li_not_pending = conversations_admin_list_ul
                        .find('[data-conversation-status="2"]')
                        .last();
                      if (li_not_pending.length) {
                        conversations.splice(
                          li_not_pending.index() + 1,
                          0,
                          conversation
                        );
                  ...
                  if (
                    !SBChat.tab_active &&
                    status_code == 2 &&
                    (is_user || payload.preview) &&
                    (message_text ||
                      conversation.getAttachments().length ||
                      payload.preview)
                  ) {
                    if (this.desktop_notifications) {
                      let user_details = [
                        users[user_id].nameBeautified,
                        users[user_id].image,
                      ];
                      SBChat.desktopNotification(
                        user_details[0],
                        payload.preview ? payload.preview : message_text,
                        user_details[1],
                        conversation_id,
                        user_id
                      );
            ...
            SBF.ajax(
              {
                ...
                agent_id: SB_ADMIN_SETTINGS.assign_conversation_to_agent
                  ? SB_ACTIVE_AGENT.id
                  : false,
    ...
    messageMenu: function (agent, message = false) {
      let code =
        (message && SB_ADMIN_SETTINGS.chatbot_features
          ? `<li data-value="bot">${sb_("Train chatbot")}</li>`
          : "") +
        ((agent &&
        ...
        (SB_ADMIN_SETTINGS.supervisor &&
          ...
          ? `<li data-value="delete">${sb_("Delete")}</li>`
          : "");
      return code
        ? `<i class="sb-menu-btn sb-icon-menu"></i><ul class="sb-menu">${code}</ul>`
        : "";
    },
    ...
    updateUserDetails() {
      ...
      conversations_area
        .find(`[data-user-id="${activeUser().id}"] .sb-name`)
        .html(activeUser().name);
      conversations_area
        .find(`.sb-top > a`)
        .html(
          SBChat.conversation ? SBChat.conversation.title : activeUser().name
        );
    ...
    setReadIcon(status_code) {
      ...
      conversations_area
        ...
        .sbActive([0, 1, 2].includes(parseInt(status_code)))
        ...
        .sbInitTooltips()
        .find("i")
        .attr("class", unread ? "sb-icon-check-circle" : "sb-icon-circle");
    },

    // Return the conversation code of the left conversations list
    getListCode: function (conversation, status) {
      if (!(conversation instanceof SBConversation)) {
        conversation = new SBConversation(
          [new SBMessage(conversation)],
          conversation
        );
      }
      ...
      if (
        !SBChat.conversation ||
        SBChat.conversation.id != conversation.id ||
        SBF.visibility_status == "hidden"
      ) {
        ...
        if (
          ...
          notification_counter[conversation.id].length
        ) {
          if (status == 2) {
            notification_counter = `<span class="sb-notification-counter">${
              notification_counter[conversation.id].length
            }</span>`;
          } else {
            notification_counter[conversation.id] = [];
      ...
      return `<li data-user-id="${conversation.get(
        "user_id"
        ...
        department_id
          ? ` data-department="${department_id}"${
              SB_ADMIN_SETTINGS.departments_show
                ? ' data-color="' +
                  this.getDepartments(department_id)["department-color"] +
                  '"'
                : ""
            }`
          : ""
      }${
        !SBF.null(conversation.get("source"))
          ? ` data-conversation-source="${conversation.get("source")}"`
          : ""
      }>${
        label_new + notification_counter
      }<div class="sb-profile"><img loading="lazy" src="${conversation.get(
        "profile_image"
      )}"><span class="sb-name">${
        conversation.get("first_name") + " " + conversation.get("last_name")
      }</span>${tags}<span class="sb-time">${SBF.beautifyTime(
        conversation.get("last_update_time")
      )}</span></div><p>${new SBMessage().strip(message)}</p></li>`;
    },
      ...
      if (typing) {
        ...
        if (!this.user_typing) {
          conversations_area
            ...
            .append(
              '<span class="sb-status-typing">' + sb_("Typing") + "</span>"
            );
    ...
    scrollTo: function () {
      ...
      conversations_admin_list_ul
        .parent()
        .scrollTop(offset - (responsive ? 120 : 80));
    },
    ...
    notificationsCounterReset: function (
      conversation_id,
      conversation = false
    ) {
      ...
      if (notification_counter && notification_counter[conversation_id]) {
        if (!conversation) {
          conversation = conversations_admin_list_ul.find(
            '[data-conversation-id="' + conversation_id + '"]'
          );
        }
    ...
    setActiveDepartment: function (department_id) {
      ...
      let department = department_id
        ? this.getDepartments(department_id)
        : false;
      ...
      select_departments
        .find(" > p")
        .attr("data-id", department ? department["department-id"] : "")
        .attr("data-value", departmnet_color)
        .html(
          (department ? department["department-name"] : sb_("None")) +
            "<span></span>"
        )
        .next()
        .sbActive(false);
      ...
      if (
        (department_filter && department_filter != department_id) ||
    ...
    getDepartments: function (department_id = false) {
      if (department_id) {
        for (var i = 0; i < SB_ADMIN_SETTINGS.departments.length; i++) {
          if (
            SB_ADMIN_SETTINGS.departments[i]["department-id"] == department_id
          ) {
    ...
    setActiveAgent: function (agent_id) {
      ...
      if (
        SB_ACTIVE_AGENT.user_type == "agent" &&
        (!SB_ADMIN_SETTINGS.assign_conversation_to_agent || agent_id)
      ) {
    ...
    mobileCloseConversation: function () {
      ...
      conversations_area
        .find(".sb-conversation,.sb-user-details")
    ...
    clickFirst: function (conversation_li = false) {
      ...
      if (conversation_li.length) {
        ...
        if (!conversations_admin_list_ul.find("li").length) {
          conversations_admin_list_ul.html(
            `<p class="sb-no-results">${sb_("No conversations found.")}</p>`
          );
        }
        if (SBF.getURL("conversation")) {
          window.history.replaceState(
            {},
            document.title,
            SBF.URL().replace("?conversation=" + SBF.getURL("conversation"), "")
          );
        }
      }
    },
    ...
    savedReplies: function (textarea, value) {
      ...
      if (last_char == "#") {
        if (
          value.length > 1 &&
          value.charAt(textarea.selectionStart - 2) == "#"
        ) {
      ...
      update: function (notes, add = false) {
        if (notes_panel.length) {
          ...
          for (var i = 0; i < notes.length; i++) {
            let note = notes[i];
            code += `<div data-id="${note.id}"><span${
              SB_ADMIN_SETTINGS.notes_hide_name ? ' class="sb-noname-note"' : ""
            }>${SB_ADMIN_SETTINGS.notes_hide_name ? "" : note["name"]}${
              SB_ACTIVE_AGENT.id == note["user_id"]
                ? '<i class="sb-edit-note sb-icon-edit"></i><i class="sb-delete-note sb-icon-close"></i>'
                : ""
            }</span><span class="sb-note-text">${note.message.replace(
              /\n/g,
              "<br>"
            )}</span></div>`;
          }
    ...
    tags: {
      ...
      getAll: function (active_tags = []) {
        ...
        for (var i = 0; i < SB_ADMIN_SETTINGS.tags.length; i++) {
          code += this.code(
            i,
            active_tags.includes(SB_ADMIN_SETTINGS.tags[i]["tag-name"])
          );
        }
        return code;
      },
      ...
      code: function (index_or_tag, active) {
        let tag = isNaN(index_or_tag)
          ? index_or_tag
          : SB_ADMIN_SETTINGS.tags[index_or_tag];
        if (tag) {
          let name = tag["tag-name"];
          return `<span data-value="${name}" data-color="${tag["tag-color"]}"${
            active ? ' class="sb-active"' : ""
          }>${sb_(name)}</span>`;
        }
        return "";
      },
    ...
    getDeliveryFailedMessage: function (source) {
      setTimeout(() => {
        conversation_area.sbInitTooltips();
      }, 300);
      return `<i class="sb-icon-warning sb-delivery-failed" data-sb-tooltip="${sb_(
        "Message not delivered to {R}."
      ).replace("{R}", SBApps.getName(source))}"> </i>`;
    },
  };
  ...
  var SBProfile = {
      ...
      activeUser().update(() => {
        ...
        activeUser().getConversations((response) => {
          ...
          if (activeUser().getExtra("phone")) {
            ...
            profile_box
              .find('.sb-top-bar [data-value="whatsapp"]')
              .sbActive(true);
          }
    ...
    populate: function (user, profile_area) {
      ...
      let code = "";
      if (
        profile_area.hasClass("sb-profile-list-conversation") &&
        SBChat.conversation
      ) {
  ...
  var SBAdmin = {
    ...
    genericPanel: function (
      ...
      for (var i = 0; i < buttons.length; i++) {
        buttons[i] =
          isString(buttons[i]) || buttons[i] instanceof String
            ? [buttons[i], false]
            : buttons[i];
        buttons_code += `<a id="sb-${SBF.stringToSlug(
          buttons[i][0]
        )}" class="sb-btn${buttons[i][1] ? ` sb-icon` : ``}">${
          buttons[i][1] ? `<i class="sb-icon-${buttons[i][1]}"></i>` : ``
        } ${sb_(buttons[i][0])}</a>`;
      }
      cnt.html(`<div class="sb-lightbox sb-${id}-box"${attrs}><div class="sb-info"></div><div class="sb-top-bar"><div>${sb_(
        title
      )}</div>
                        <div>
                            ${buttons_code}
  ...
  $(document).ready(function () {
    ...
    conversations_area_list = conversations_area.find(
    ...
    SITE_URL =
      typeof SB_URL != ND
        ...
        : "";
    woocommerce_products_box = conversations_area.find(
      ".sb-woocommerce-products"
    );
    ...
    if (SBApps.is("woocommerce")) {
      ...
      woocommerce_products_box_ul =
        woocommerce_products_box.find(" > div > ul");
    }
    if (localhost) {
      clearCache();
    }
    ...
    $(window).keydown(function (e) {
      ...
      if ([13, 27, 32, 37, 38, 39, 40, 46, 90].includes(code)) {
        if (admin.find(".sb-dialog-box").sbActive()) {
          ...
          [38, 40, 46, 90].includes(code) &&
          conversations_area.sbActive() &&
          !admin.find(".sb-lightbox").sbActive()
        ) {
          ...
          if (code == 46) {
            ...
            if (code == 40) {
              ...
              code == 90 &&
              is_editor_focus &&
              SBConversations.previous_editor_text
            ) {
    ...
    document.onpaste = function (pasteEvent) {
      ...
      if (item.type.indexOf("image") === 0) {
        ...
        reader.onload = function (event) {
          ...
          let bytes =
            data[0].indexOf("base64") >= 0 ? atob(data[1]) : decodeURI(data[1]);
          ...
          form.append(
            "file",
            new Blob([ia], { type: data[0].split(":")[1].split(";")[0] }),
            "image_print.jpg"
          );
    ...
    let messages = [
      ...
      )} <a href="https://board.support/shop/{R}" target="_blank">${sb_(
        "here"
      )}</a>.`,
    ];
        ...
        (response) => {
          ...
          for (var key in response) {
            if (SBApps.is(key)) {
              ...
              code += `<div class="sb-input"><span>${names[key]}</span><div${
                updated ? ' class="sb-green"' : ""
              }>${
                updated
                  ? sb_("You are running the latest version.")
                  : sb_("Update available! Please update now.")
              } ${sb_("Your version is")} V ${SB_VERSIONS[key]}.</div></div>`;
            }
          }
          if (updates) {
            ...
            (response) => {
              if (response === true) {
                infoBottom(
                  `${sb_(
                    "Update available."
                  )} <span onclick="$(\'.sb-version\').click()">${sb_(
    ...
    $(admin).on("click", ".sb-apps > div", function () {
      ...
      let is_active =
        SBApps.is(app_name) &&
        (!is_cloud || SB_CLOUD_ACTIVE_APPS.includes(app_name));
      ...
      box
        ...
        .attr("href", "https://board.support/shop/" + app_name + ga);
      box
        .find(".sb-btn-app-details")
        .attr(
          "href",
          (is_cloud ? WEBSITE_URL : "https://board.support/") + app_name + ga
        );
      box.sbShowLightbox();
    });
    ...
    $(admin).on("click", ".sb-app-box .sb-btn-app-setting", function () {
      settings_area
        .find("#tab-" + $(this).closest("[data-app]").attr("data-app"))
        .click();
      admin.sbHideLightbox();
    });
    ...
    if (
      ...
      (SB_ADMIN_SETTINGS.desktop_notifications == "all" ||
        SB_ADMIN_SETTINGS.desktop_notifications == "agents") &&
      !SB_ADMIN_SETTINGS.push_notifications
    ) {
    ...
    $(admin).on("click", ".sb-collapse-btn", function () {
      ...
      $(this)
        .parent()
        .find("> div, > ul")
        .css({ height: height, "max-height": height });
    ...
    if (responsive) {
      ...
      document.addEventListener(
        ...
        (e) => {
          ...
          if (Math.abs(x_diff) > Math.abs(y_diff)) {
            var target_sub = [];
            touchmove = conversations_area.sbActive()
              ? [
                  conversations_admin_list_ul.find(".sb-active"),
                  conversations_area_list,
                  1,
                ]
              : [
                  users_table.find(`[data-user-id="${activeUser().id}"]`),
                  profile_box,
                  2,
                ];
            if (x_diff > 150) {
      ...
      if (!SB_ADMIN_SETTINGS.hide_conversation_details) {
        ...
        conversations_area
          .find('.sb-menu-mobile [data-value="panel"]')
          .sbActive(true);
      }
    }
    ...
    if ($(window).width() < 913) {
      $(conversations_area).on("click", "> .sb-btn-collapse", function () {
        ...
        conversations_area
          .find(
            $(this).hasClass("sb-left") ? ".sb-admin-list" : ".sb-user-details"
          )
    ...
    $(header).on("click", " .sb-admin-nav a", function () {
            ...
            SBF.ajax(
              ...
              (response) => {
                ...
                if (response && !SB_ADMIN_SETTINGS.cloud) {
                  SBSettings.visibility(
                    0,
                    response["push-notifications"] &&
                      response["push-notifications"][0][
                ...
                SBSettings.visibility(
                  1,
                  response["messenger"]
                    ? response["messenger"][0]["messenger-sync-mode"][0] !=
                        "manual"
                    : true
                );
                SBSettings.visibility(
                  2,
                  response["open-ai"]
                    ? response["open-ai"][0]["open-ai-mode"][0] != "assistant"
                    : true
                );
      ...
      if (
        ...
        ((slug == "conversations" && !SBF.getURL("conversation")) ||
          ...
          (slug == "articles" && !SBF.getURL("article")))
      ) {
        pushState("?area=" + slug);
      }
    });
    ...
    $(conversations_area).on("click", ".sb-top ul a", function () {
      let status_code;
      let selected_conversations = conversations_admin_list_ul
        .find(".sb-active")
        .map(function () {
          return {
            id: $(this).attr("data-conversation-id"),
            user_id: $(this).attr("data-user-id"),
            status_code: $(this).attr("data-conversation-status"),
          };
        })
        .toArray();
      let selected_conversations_length = selected_conversations.length;
      let multi_selection = selected_conversations_length > 1;
      let message = multi_selection
      ...
      let on_success = (response, action) => {
        ...
        if (action == "email") {
          actioninfoBottom(
            success
              ? sb_("Transcript sent to user's email.") +
                  ' <a href="' +
                  response +
                  '" target="_blank">' +
                  sb_("View transcript") +
                  "</a>"
              : "Transcript sending error: " + response,
            success ? "" : "error"
          );
        }
      };
      switch (value) {
        ...
        case "transcript":
          ...
          if (
            action == "email" &&
            (!activeUser() || !activeUser().get("email"))
          ) {
            action = "";
          }
          SBConversations.transcript(
            selected_conversations[0].id,
            selected_conversations[0].user_id,
            action,
            (response) => on_success(response, action)
          );
          loading(this);
          break;
        case "read":
      ...
      if (status_code) {
        infoPanel(message, "alert", function () {
          let active_conversations_filter = conversations_filters
            .eq(0)
            .find("p")
            .attr("data-value");
          let last_conversation_id =
            selected_conversations[selected_conversations_length - 1].id;
          for (var i = 0; i < selected_conversations_length; i++) {
            ...
            SBF.ajax(
              ...
              () => {
                ...
                if (
                  (active_conversations_filter == 0 &&
                    [3, 4].includes(status_code)) ||
                  (active_conversations_filter == 3 &&
                    [0, 1, 2, 4].includes(status_code)) ||
                  (active_conversations_filter == 4 && status_code != 4)
                ) {
                  let previous = false;
                  SBConversations.updateMenu();
                  if (
      ...
      (response) => {
        ...
        if (Array.isArray(response)) {
          if (response.length && response[0]["reply-name"]) {
            ...
            for (var i = 0; i < response.length; i++) {
              code += `<li><div>${
                response[i]["reply-name"]
              }</div><div>${response[i]["reply-text"].replace(
                /\\n/g,
                "\n"
              )}</div></li>`;
            }
    ...
    $(admin).on("click", ".sb-btn-open-ai", function () {
      ...
      let textarea = is_editor
        ? conversations_area.find(".sb-editor textarea")
        : dialogflow_intent_box.find("textarea");
      SBApps.openAI.rewrite(
        textarea.val(),
    ...
    $(saved_replies).on("click", ".sb-replies-list li", function () {
      SBChat.insertText(
        $(this).find("div:last-child").text().replace(/\\n/g, "\n")
      );
      SBF.deactivateAll();
    ...
    $(document).on("SBMessageSent", function (e, response) {
          ...
          (response) => {
            for (var i = 0; i < response.length; i++) {
              if (response[i] && response[i].error) {
                infoPanel(
                  message_part + " Messenger: " + response[i].error.message,
                  "info",
                  false,
                  "error-fb"
                );
        ...
        SBApps.viber.send(
          ...
          (response) => {
            if (
              ...
              infoPanel(
                message_part + " Viber: " + JSON.stringify(response),
                "info",
                false,
                "error-vb"
              );
      ...
      if (SBApps.line.check(conversation)) {
        SBApps.line.send(
          ...
          (response) => {
            if (response.error) {
              infoPanel(
                message_part + " LINE: " + JSON.stringify(response),
                "info",
                false,
                "error-ln"
              );
      ...
      if (SBApps.wechat.check(conversation)) {
        SBApps.wechat.send(
          user.getExtra("wechat-id").value,
          response.message,
          response.attachments,
          (response) => {
            if (!response || response.errmsg != "ok") {
              infoPanel(
                message_part + " WeChat: " + JSON.stringify(response),
                "info",
                false,
                "error-wc"
              );
          ...
          if (message_original) {
            ...
            SBApps.dialogflow.translate(
              ...
              (response_2) => {
                ...
                conversations_admin_list_ul
                  .find(
                    `[data-conversation-id="${response.conversation_id}"] p`
                  )
                  .html(response_2[0]);
              },
              [message.id],
        ...
        if (
          ...
          infoPanel(
            "Error. Message not sent to WhatsApp. Error message: " +
              (payload.ErrorCode ? payload.ErrorCode : payload.errors[0].title),
            "info"
          );
        }
    ...
    $(document).on("SBNotificationsSent", function (e, response) {
      infoBottom(
        `The user ${
          response.includes("cron") ? "will be" : "has been"
        } notified by email${
          ...
          SBF.ajax(
            ...
            (response) => {
              ...
              if (response.length) {
                if (!responsive) {
                  if (SBChat.conversation) {
                    let conversation = getListConversation(
                      SBChat.conversation.id
                    );
    ...
    $(dialogflow_intent_box).on("change", "#sb-intents-select", function () {
      ...
      dialogflow_intent_box
        ...
        .css("opacity", intent ? 0.5 : 1)
        .find("textarea")
        .val(
          intent
            ? SBApps.dialogflow.getIntent(intent).messages[0].text.text[0]
            : SBApps.dialogflow.original_response
        );
      dialogflow_intent_box
        .find("#sb-train-chatbots")
        .val(intent ? "dialogflow" : "");
    });

    $(dialogflow_intent_box).on("change", "textarea", function () {
      clearTimeout(timeout);
      timeout = setTimeout(() => {
        SBApps.dialogflow.original_response = dialogflow_intent_box
          .find("textarea")
          .val();
      }, 500);
    });
    ...
    $(dialogflow_intent_box).on("change", "#sb-train-chatbots", function () {
      dialogflow_intent_box
        .find(".sb-type-text:not(.sb-first)")
        .setClass("sb-hide", $(this).val() == "open-ai");
    });
    ...
    notes_panel.on("click", "> i,.sb-edit-note", function (e) {
      let note = $(this).hasClass("sb-edit-note")
        ? $(this).closest("[data-id]")
        : false;
      SBAdmin.genericPanel(
        "notes",
        note ? "Edit note" : "Add new note",
        `<div class="sb-input-setting sb-type-textarea"><textarea${
          note ? ' data-id="' + note.attr("data-id") + '"' : ""
        } placeholder="${sb_("Write here your note...")}">${
          note ? note.find(".sb-note-text").html().replaceAll("<br>", "\n") : ""
        }</textarea></div>`,
        [[note ? "Update note" : "Add note", note ? "check" : "plus"]]
      );
      if (SBApps.is("dialogflow") && SB_ADMIN_SETTINGS.note_data_scrape) {
        ...
        admin
          ...
          .parent()
          .prepend(
            `<div id="note-ai-scraping" class="sb-input-setting sb-type-select"><select><option value="">${sb_(
              "Data scraping"
    ...
    tags_panel.on("click", "> i", function (e) {
      ...
      SBAdmin.genericPanel(
        ...
        "Manage tags",
        code
          ? '<div class="sb-tags-cnt">' + code + "</div>"
          : "<p>" + sb_("Add tags from Settings > Admin > Tags.") + "</p>",
        ["Save tags"]
      );
      e.preventDefault();
      return false;
    ...
    $(suggestions_area).on("mouseover", "span", function () {
      timeout = setTimeout(() => {
        $(this).addClass("sb-suggestion-full");
      }, 2500);
    });
          ...
          conversations_area
            ...
            .prepend(
              `<li data-value="${
                ...
                (agent && message_user_type != "bot" && !translation) ||
                  ((!agent || message_user_type == "bot") && translation)
                  ? "View original message"
                  : "View translation"
              )}</li>`
    ...
    $(profile_edit_box).on("click", ".sb-save", function () {
      ...
      if (
        SB_ACTIVE_AGENT.id == activeUser().id &&
        settings.user_type[0] == "agent" &&
        SB_ACTIVE_AGENT.user_type == "admin"
      ) {
        SBProfile.showErrorMessage(
          profile_edit_box,
    ...
    $(admin).on("click", ".sb-send-direct-message", function () {
      let type = $(this).attr("data-type")
        ? $(this).attr("data-type")
        : direct_message_box.attr("data-type");
      let whatsapp = type == "whatsapp";
      let box = whatsapp
        ? admin.find("#sb-whatsapp-send-template-box")
        : direct_message_box;
      ...
      if (whatsapp) {
        ...
        template_languages = select
          .find("option:selected")
          .attr("data-languages");
        phone_number_id = select.find("option:selected").attr("data-phone-id");
        parameters = ["header", "body", "button"].map((id) =>
          box.find(`#sb-whatsapp-send-template-${id}`).val()
        );
      }
    ...
    function recursiveSending(
      ...
      let settings = {
        ...
        email: ["create-email", "emails", " an email address.", false],
        custom_email: [
          "send-custom-email",
          "emails",
          " an email address.",
          ...
          if (response) {
            if (
              ...
              (("status" in response && response.status == 400) ||
                ("error" in response &&
                  ![131030, 131009].includes(response.error.code)))
            ) {
              SBForm.showErrorMessage(
                box,
                response.error
                  ? response.error.message
                  : `${response.message} Details at ${response.more_info}`
              );
              console.error(response);
              box.find(".sb-loading").sbLoading(false);
              box.find(".sb-bottom > div").html("");
              ...
              if (user_ids_sms.length) {
                ...
                if (settings[3]) {
                  SBF.ajax({
                    ...
                    name: settings[3],
                    value: message.substr(0, 18) + " | " + user_ids_length,
                  });
                }
              }
              infoBottom(
      ...
      SBF.ajax(
        ...
        (response) => {
          ...
          SBAdmin.genericPanel(
            ...
            `<div class="sb-setting"><div class="sb-repeater"><div class="repeater-item"><div><label>${sb_(
              "Question"
            )}</label><input data-id="open-ai-faq-question" type="text"></div><div><label>${sb_(
              "Answer"
            )}</label><textarea data-id="open-ai-faq-answer"></textarea></div><i class="sb-icon-close"></i></div></div></div><a class="sb-btn sb-btn-white sb-repeater-add">${sb_(
              "Add new item"
            )}</a>`,
            ["Train the chatbot"],
            "",
          ...
          for (var i = 0; i < response.length; i++) {
            faq.push({
              "open-ai-faq-question": response[i][0],
              "open-ai-faq-answer": response[i][1],
            });
          }
          if (faq.length) {
            admin
              ...
              .html(
                SBSettings.repeater(
                  "set",
                  faq,
                  admin.find(".sb-open-ai-faq-box .repeater-item:last-child")
                )
              );
          }
        }
    ...
    $(admin).on("click", "#sb-train-the-chatbot", function (e) {
      if (!loading(this)) {
        let questions_answers = SBSettings.repeater(
          "get",
          admin.find(".sb-open-ai-faq-box .repeater-item")
        ).map(function (item) {
          return [item["open-ai-faq-question"], item["open-ai-faq-answer"]];
        });
        SBF.ajax(
          {
    ...
    $(settings_area).on("click", "#dialogflow-sync-btn a", function (e) {
      ...
      if (
        ...
        settings_area.find("#google-sync-mode select").val() == "auto"
      ) {
        if (SB_ADMIN_SETTINGS.credits) {
          window.open(
            url.replace("{client_id}", SB_ADMIN_SETTINGS.google_client_id)
          );
          e.preventDefault();
          return false;
        }
        ...
        if (
          client_id &&
          settings_area.find("#google-client-secret input").val()
        ) {
    ...
    $(settings_area).on(
      "click",
      "#test-sms-user a, #test-sms-agent a",
      function () {
        ...
        if (phone_number && !loading(this)) {
          SBF.ajax(
            ...
            (response) => {
              infoPanel(
                response && ["sent", "queued"].includes(response.status)
                  ? "The message has been sent."
    ...
    $(settings_area).on(
      "click",
      "#open-ai-user-expressions-btn a",
      function (e) {
        if (!$(this).sbLoading()) {
          infoPanel(
    ...
    $(settings_area).on("click", "#open-ai-train-btn a", function (e) {
      let url_inputs = settings_area.find(
      ...
      if (
        !url_inputs.length ||
        (!url_inputs[0].value &&
          (url_inputs.length == 1 || !url_inputs[1].value))
      ) {
        return infoPanel(
      ...
      SBF.ajax(
        { function: "open-ai-get-embeddings-delete", sources: urls },
        () => {
    ...
    if (!SB_ADMIN_SETTINGS.cloud) {
      ...
      $(settings_area).on(
        "click",
        "#push-notifications-sw-path a",
        function (e) {
          let path = urlStrip(location.href)
    ...
    $(settings_area).on("click", "#push-notifications-btn a", function (e) {
      if (
        SB_ADMIN_SETTINGS.cloud ||
        settings_area.find("#push-notifications-provider select").val() ==
          "onesignal"
      ) {
    ...
    $(settings_area).on("input", "#sb-search-settings", function () {
      ...
      SBF.search(search, () => {
        ...
        if (search.length > 2) {
          let navs = settings_area
            .find("> .sb-tab > .sb-nav li")
            .map(function () {
          ...
          settings_area.find(".sb-setting").each(function () {
            if (
              $(this).attr("data-keywords").includes(search) ||
              $(this).attr("id").replaceAll("-", "-").includes(search) ||
              $(this)
              ...
              code += `<div data-tab-index="${index}" data-setting="${$(
                this
              ).attr("id")}">${navs[index]} > ${$(this)
                .find("h2")
                .text()}</div>`;
            }
          });
        ...
        infoPanel(
          `<pre>${
            ...
            (id == "sms-btn"
              ? "/include/api.php"
              : "/apps/" +
                (id.includes("-") ? id.substring(0, id.indexOf("-")) : id) +
                "/post.php") +
            extra +
            cloudURL().replace("&", extra ? "&" : "?")
          }</pre>`,
          "info"
        );
        return false;
    ...
    $(settings_area).on(
      ...
      function (e) {
        ...
        SBF.ajax(
          ...
          (response) => {
            infoPanel(
              calls[2][0] in response && response[calls[2][0]] == calls[2][1]
    ...
    $(settings_area).on(
      "click",
      ".sb-translations .sb-menu-wide li",
      function () {
        settings_area
          .find(`.sb-translations [data-area="${$(this).data("value")}"]`)
          .sbActive(true)
          .siblings()
          .sbActive(false);
      }
    ...
    $(settings_area).on("click", ".sb-add-translation", function () {
      settings_area
        .find(".sb-translations-list > .sb-active")
        .prepend(
          `<div class="sb-input-setting sb-type-text sb-new-translation"><input type="text" placeholder="${sb_(
            "Enter original text..."
          )}"><input type="text" placeholder="${sb_(
            "Enter translation..."
          )}"></div></div>`
        );
    });
    ...
    $(settings_area).on("input", ".sb-search-translation input", function () {
      ...
      SBF.search(search, () => {
        if (search.length > 1) {
          settings_area
            .find(".sb-translations .sb-content > .sb-active label")
            .each(function () {
    ...
    $(articles_area).on("click", ".ul-articles li", function (e) {
      infoPanel(
        ...
        false,
        false,
        !articles_save_required,
        () => {
          $(this).parent().find("li").sbActive(false);
          $(this)
            .parent()
            .find(`[data-id="${SBArticles.activeID()}"]`)
            .sbActive(true);
        }
      );
    });
    ...
    $(conversations_area).on(
      "click",
      ".sb-woocommerce-orders > div > span",
      function (e) {
        let parent = $(this).parent();
    ...
    $(conversations_area).on("click", ".sb-btn-woocommerce", function () {
      if (
        woocommerce_products_box_ul.sbLoading() ||
        (activeUser() != false &&
          activeUser().language != SBApps.woocommerce.popupLanguage)
      ) {
    ...
    $(woocommerce_products_box).on("click", ".sb-search-btn i", function () {
      SBF.searchClear(this, () => {
        SBApps.woocommerce.popupSearch($(this).next());
      });
    });
    ...
    $(woocommerce_products_box).on(
      "click",
      ".sb-woocommerce-products-list li",
      function () {
    ...
    $(conversations_area).on(
      "click",
      ".sb-panel-woocommerce .sb-add-cart-btn",
      function () {
        if ($(this).sbLoading()) return;
        if (SBChat.user_online) {
          SBApps.woocommerce.popupPopulate();
          ...
          SBF.ajax(
            {
              function:
                ...
                (id == "wc-dialogflow-synch" ? "entities" : "intents"),
            },
            (response) => {
              $(this).sbLoading(false);
              infoPanel(
    ...
    $(settings_area).on("click", "#opencart-sync a", function (e) {
      ...
      SBF.ajax(
        ...
        (response) => {
          $(this).sbLoading(false);
          infoPanel(
            response === true ? "Users successfully imported." : response,
            "info"
          );
        }
      );
    ...
    $(admin).on("click", ".sb-language-switcher > i", function () {
      ...
      for (var key in SB_LANGUAGE_CODES) {
        if (!active_languages.includes(key)) {
          code += `<div data-language="${key}"><img src="${SB_URL}/media/flags/${key}.png" />${sb_(
            SB_LANGUAGE_CODES[key]
          )}</div>`;
        }
      }
      ...
      SBAdmin.genericPanel(
        ...
        code,
        [],
        ' data-source="' + switcher.attr("data-source") + '"',
        true
      );
    });
    ...
    $(admin).on("click", ".sb-language-switcher img", function () {
      ...
      switch (item.parent().attr("data-source")) {
        case "article-categories":
          SBArticles.categories.show(
            SBArticles.categories.activeID(),
            language
          );
          break;
        case "articles":
          let previous_active = articles_content.find(
            ".sb-language-switcher .sb-active"
          );
          infoPanel(
            "The changes will be lost.",
            "alert",
        ...
        case "settings":
          ...
          SBSettings.translations.save(
            item,
            active
              ? item.attr("data-language")
              : active_language.length
              ? active_language.attr("data-language")
              : false
          );
    ...
    $(admin).on("click", ".sb-language-switcher span > i", function () {
      ...
      infoPanel(
        sb_("The {T} translation will be deleted.").replace(
          "{T}",
          sb_(SB_LANGUAGE_CODES[language])
        ),
        "alert",
        () => {
          switch (item.parent().attr("data-source")) {
    ...
    $(admin).on("click", '[data-button="toggle"]', function () {
      ...
      hide.hide();
      SBAdmin.open_popup =
        show.hasClass("sb-lightbox") || show.hasClass("sb-popup")
          ? show
          : false;
    });
          ...
          if (response[0] == "success") {
            ...
            if (type == "upload-image") {
              if ($(upload_target).attr("data-value")) {
                SBF.ajax({
                  function: "delete-file",
                  path: $(upload_target).attr("data-value"),
                });
              }
              $(upload_target)
                .attr("data-value", response[1])
                .css("background-image", `url("${response[1]}")`);
            }
            if (type == "upload-file") {
      ...
      if ($(SBAdmin.open_popup).length) {
        ...
        if (
          ...
          if (popup.hasClass("sb-popup")) {
            ...
            !SBAdmin.open_popup ||
            !["sb-embeddings-box"].includes(SBAdmin.open_popup.attr("id"))
          ) {
            admin.sbHideLightbox();
          }
          SBAdmin.open_popup = false;
    ...
    SBF.ajax(
      ...
      (response) => {
        ...
        if (SBF.getURL("conversation")) {
          ...
          !SBF.getURL("setting") &&
          !SBF.getURL("report") &&
          (!SBF.getURL("area") || SBF.getURL("area") == "conversations")
        ) {
          SBConversations.clickFirst();
        }
        SBConversations.startRealTime();
...
!(function (a, b) {
  ...
  function d(a, b, c) {
    var d = o.options.grey,
      e = {};
    return (
      (e.RGB = { r: a.r, g: a.g, b: a.b }),
      (e.rgb = { r: b.r, g: b.g, b: b.b }),
      (e.alpha = c),
      (e.equivalentGrey = n(d.r * a.r + d.g * a.g + d.b * a.b)),
      (e.rgbaMixBlack = i(b, { r: 0, g: 0, b: 0 }, c, 1)),
      (e.rgbaMixWhite = i(b, { r: 1, g: 1, b: 1 }, c, 1)),
      (e.rgbaMixBlack.luminance = h(e.rgbaMixBlack, !0)),
      (e.rgbaMixWhite.luminance = h(e.rgbaMixWhite, !0)),
      o.options.customBG &&
        ((e.rgbaMixCustom = i(b, o.options.customBG, c, 1)),
        (e.rgbaMixCustom.luminance = h(e.rgbaMixCustom, !0)),
        (o.options.customBG.luminance = h(o.options.customBG, !0))),
      e
    );
  }
  function e(a, b) {
    ...
    if ("alpha" !== a) {
      ...
      (z = u.rgb),
        (q.HEX = r.RGB2HEX(z)),
        (q.equivalentGrey =
          s.grey.r * q.rgb.r + s.grey.g * q.rgb.g + s.grey.b * q.rgb.b),
        (q.webSave = e = f(z, 51)),
        (q.webSmart = k = f(z, 17)),
        (q.saveColor =
          z.r === e.r && z.g === e.g && z.b === e.b
            ? "web save"
            : z.r === k.r && z.g === k.g && z.b === k.b
            ? "web smart"
            : ""),
        (q.hueRGB = v.hue2RGB(q.hsv.h)),
        b && (q.background = d(z, q.rgb, q.alpha));
    }
    var B,
      C,
      D,
      ...
      H = q.background;
    return (
      (B = i(E, { r: 0, g: 0, b: 0 }, F, 1)),
      (B[G] = h(B, !0)),
      (q.rgbaMixBlack = B),
      (C = i(E, { r: 1, g: 1, b: 1 }, F, 1)),
      (C[G] = h(C, !0)),
      (q.rgbaMixWhite = C),
      s.customBG &&
        ((D = i(E, H.rgbaMixCustom, F, 1)),
        (D[G] = h(D, !0)),
        (D.WCAG2Ratio = j(D[G], H.rgbaMixCustom[G])),
        (q.rgbaMixBGMixCustom = D),
        (D.luminanceDelta = m.abs(D[G] - H.rgbaMixCustom[G])),
        (D.hueDelta = g(H.rgbaMixCustom, D, !0))),
      (q.RGBLuminance = h(z)),
      (q.HUELuminance = h(q.hueRGB)),
      s.convertCallback && s.convertCallback(q, a),
      q
    );
  }
  function f(a, b) {
  ...
  function g(a, b, c) {
    return (
      ((m.max(a.r - b.r, b.r - a.r) +
        m.max(a.g - b.g, b.g - a.g) +
        m.max(a.b - b.b, b.b - a.b)) *
        (c ? 255 : 1)) /
      765
    );
  }
  function h(a, b) {
    for (
      var c = b ? 1 : 255,
        d = [a.r / c, a.g / c, a.b / c],
        e = o.options.luminance,
        f = d.length;
      f--;

    )
      d[f] =
        d[f] <= 0.03928 ? d[f] / 12.92 : m.pow((d[f] + 0.055) / 1.055, 2.4);
  ...
  function j(a, b) {
    var c = 1;
    return (
      (c = a >= b ? (a + 0.05) / (b + 0.05) : (b + 0.05) / (a + 0.05)),
      n(100 * c) / 100
    );
  }
  function k(a, b, c) {
  ...
  var l = {
    ...
    o = {},
    p = {},
    q = { r: 0.298954, g: 0.586434, b: 0.114612 },
    ...
    t = function (a, d) {
      ...
      (e = f.customBG),
        (f.customBG = "string" == typeof e ? v.txt2color(e).rgb : e),
        (p = c(a.colors, f.color, b, !0));
    },
    u = function (a) {
      o !== a && ((o = a), (p = a.colors));
    };
  (s.prototype.setColor = function (a, d, f) {
    return (
      u(this),
      a
        ? c(this.colors, a, d, b, f)
        : (f !== b && (this.colors.alpha = k(f, 0, 1)), e(d))
    );
  }),
    (s.prototype.setCustomBackground = function (a) {
      return (
        u(this),
        (this.options.customBG = "string" == typeof a ? v.txt2color(a).rgb : a),
        c(this.colors, b, "rgb")
      );
    }),
  ...
  var v = {
    ...
    rgb2hsv: function (a) {
      ...
      return (
        g > f && ((f = g + ((g = f), 0)), (h = -1)),
        (c = g),
        f > e && ((e = f + ((f = e), 0)), (h = -2 / 6 - h), (c = m.min(f, g))),
        (b = e - c),
        (d = e ? b / e : 0),
        {
          h:
    ...
    hsv2hsl: function (a) {
      var b = (2 - a.s) * a.v,
        c = a.s * a.v;
      return (
        (c = a.s ? (1 > b ? (b ? c / b : 0) : c / (2 - b)) : 0),
        { h: a.h, s: a.v || c ? c : (p && p.hsl && p.hsl.s) || 0, l: b / 2 }
      );
    },
  ...
  (function (a, b) {
    "object" == typeof exports
      ? (module.exports = b(a, require("jquery"), require("colors")))
      : "function" == typeof define && define.amd
      ? define(["jquery", "colors"], function (c, d) {
          return b(a, c, d);
        })
    ...
    function h(c) {
      ...
      c
        ? ((s = g(d)),
          (s._colorMode = s.data("colorMode")),
          (p.$trigger = d),
          (t || i())
            .css(
              r.positionCallback.call(p, d) || {
                left:
                  (t._left = f.left) -
                  ((t._left += t._width - (h.scrollLeft() + h.width())) + k > 0
                    ? t._left + k
                    : 0),
                top:
                  (t._top = f.top + d.outerHeight()) -
                  ((t._top += t._height - (h.scrollTop() + h.height())) + k > 0
                    ? t._top + k
                    : 0),
              }
            )
            .show(r.animationSpeed, function () {
              c !== !0 &&
                ((y.toggle(!!r.opacity)._width = y.width()),
                (v._width = v.width()),
                (v._height = v.height()),
                (u._height = u.height()),
                q.setColor(e(s[0])),
            ...
            .off(".tcp")
            .on(D, ".cp-xy-slider,.cp-z-slider,.cp-alpha", j))
        : p.$trigger &&
          b(t)
            .hide(r.animationSpeed, function () {
              n(!1), (p.$trigger = null);
            })
            .off(".tcp");
    }
    function i() {
      return (
        b("head")[r.cssPrepend ? "prepend" : "append"](
        ...
        b(H)
          ...
          .show(0, function () {
            (p.$UI = t = b(this)),
              (F = r.GPU && t.css("perspective") !== d),
              (u = b(".cp-z-slider", this)),
              (v = b(".cp-xy-slider", this)),
              (w = b(".cp-xy-cursor", this)),
              (x = b(".cp-z-cursor", this)),
              (y = b(".cp-alpha", this)),
              (z = b(".cp-alpha-cursor", this)),
              r.buildCallback.call(p, t),
              t
                .prepend("<div>")
                .children()
                .eq(0)
                .css("width", t.children().eq(0).width()),
              (t._width = this.offsetWidth),
    ...
    function j(a) {
      ...
      (a.button || a.which) > 1 ||
        ...
        (a.returnValue = !1),
        (s._offset = b(this).offset()),
        (c = "xy_slider" === c ? k : "z_slider" === c ? l : m)(a),
        n(),
        A.on(E, function () {
          A.off(".tcp");
        }).on(C, function (a) {
    ...
    function k(a) {
      ...
      q.setColor(
        { s: (c / v._width) * 100, v: 100 - (d / v._height) * 100 },
        "hsv"
      );
    }
    function l(a) {
      var b = f(a).pageY - s._offset.top;
      q.setColor({ h: 360 - (b / u._height) * 360 }, "hsv");
    }
    function m(a) {
    ...
    function n(a) {
      var b = q.colors,
        ...
        h = b.HUELuminance > 0.22 ? e : f,
        i = b.rgbaMixBlack.luminance > 0.22 ? e : f,
      ...
      (v._css = {
        ...
        (w._css = {
          ...
          left: F ? "" : k,
          top: F ? "" : l,
          borderColor: b.RGBLuminance > 0.22 ? e : f,
        }),
        (x._css = {
        ...
        (s._css = {
          backgroundColor: t ? "" : g,
          color: t ? "" : b.rgbaMixBGMixCustom.luminance > 0.22 ? e : f,
        }),
        (s.text = t ? "" : p !== g ? g : ""),
        a !== d ? o(a) : G(o);
    }
    function o(a) {
      v.css(v._css),
        ...
        y.css(y._css),
        z.css(z._css),
        r.doRender && s.css(s._css),
        s.text && s.val(s.text),
        r.renderCallback.call(p, s, "boolean" == typeof a ? a : d);
    }
    var p,
      q,
      r,
    ...
    (J.prototype = { render: n, toggle: h }),
      (b.fn.colorPicker = function (c) {
        ...
        return (
          ...
          !p &&
            c.scrollResize &&
            b(a).on("resize.tcp scroll.tcp", function () {
              p.$trigger && p.toggle.call(p.$trigger[0], !0);
            }),
          (B = B.add(this)),
          (this.colorPicker = p || new J(c)),
          (this.options = c),
          b(c.body)
            .off(".tcp")
            .on(D, function (a) {
          ...
          this.on("focusin.tcp click.tcp", function (a) {
            (p.color.options = b.extend(p.color.options, (r = d.options))),
              h.call(this, a);
          })
            ...
            .each(function () {
              var a = e(this),
                ...
                f = g(b(this));
              f
                .data("colorMode", d[1] ? d[0].substr(0, 3) : "HEX")
                .attr("readonly", r.preventFocus),
                c.doRender &&
                  f.css({
                    "background-color": a,
                    color: function () {
                      return q.setColor(a).rgbaMixBGMixCustom.luminance > 0.22
                        ? c.dark
                        : c.light;
                    },
                  });
